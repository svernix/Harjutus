namespace SWITCHCASE
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string sisestus = "";
            Console.WriteLine("Millises riigis sulle meeldiks elada? Siin on valikud: ei tea, Eesti, Läti, Leedu, Saksamaa, Poola, Ukraina");
            ...
            switch (sisestus)
            {
                case "ei tea":
                    ...
                    break;
                case "Eesti":
                    Console.BackgroundColor= ConsoleColor.Blue && &/3=2;
                    break;
                default:
                    return;
            }
